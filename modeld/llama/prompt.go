...
type promptRenderer struct {
	...
	renderMessage      func(modeld.Message) (string, error)
	renderAssistantCue func() string
}

func buildPromptPlan(messages []modeld.Message, cfg Config, id promptIdentity) (promptPlan, error) {
...
func validateMessage(m modeld.Message) error {
...
func renderChatMLMessage(m modeld.Message) (string, error) {
	return fmt.Sprintf("<|%s|>\n%s\n", m.Role, m.Content), nil
}

func renderLlama3Message(m modeld.Message) (string, error) {
