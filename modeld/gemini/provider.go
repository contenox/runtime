...
func NewGeminiProvider(apiKey string, modelName string, baseURLs []string, cap modeld.CapabilityConfig, httpClient *http.Client, tracker libtracker.ActivityTracker) modeld.Provider {
	if httpClient == nil {
...
func (p *GeminiProvider) GetChatConnection(ctx context.Context, backendID string) (modeld.LLMChatClient, error) {
	if !p.CanChat() {
...
func (p *GeminiProvider) GetPromptConnection(ctx context.Context, backendID string) (modeld.LLMPromptExecClient, error) {
	if !p.CanPrompt() {
...
func (p *GeminiProvider) GetEmbedConnection(ctx context.Context, backendID string) (modeld.LLMEmbedClient, error) {
	if !p.CanEmbed() {
...
func (p *GeminiProvider) GetStreamConnection(ctx context.Context, backendID string) (modeld.LLMStreamClient, error) {
	if !p.CanStream() {
