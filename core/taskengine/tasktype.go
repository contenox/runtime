...
type Transition struct {
	...
	OnError string `yaml:"on_failure" json:"on_failure"`
...
type ChainTask struct {
	...
	// ValidConditions defines valid values for condition tasks (PromptToCondition).
	...
	Transition Transition `yaml:"next_task" json:"next_task"`
	...
	RetryOnError int `yaml:"retry_on_error,omitempty" json:"retry_on_error,omitempty"`
}
...
type ChainDefinition struct {
	...
	MaxTokenSize int64 `yaml:"max_token_size" json:"max_token_size"`
