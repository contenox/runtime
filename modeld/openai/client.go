...
type openAIChatRequest struct {
	...
	// ReasoningEffort maps the existing modeld.WithThink values onto OpenAI's
...
func buildOpenAIRequest(modelName string, messages []modeld.Message, args []modeld.ChatArgument) (openAIChatRequest, map[string]string) {
...
func (c *openAIClient) clampChatMaxOutputTokens(req *openAIChatRequest) {
	...
	req.MaxCompletionTokens = modeld.ClampMaxOutputTokensPtr(req.MaxCompletionTokens, c.maxOutputTokens)
}
...
func (c *openAIClient) clampResponsesMaxOutputTokens(req *openAIResponsesRequest) {
	...
	req.MaxOutputTokens = modeld.ClampMaxOutputTokensPtr(req.MaxOutputTokens, c.maxOutputTokens)
}

func buildOpenAIRequestWithCapabilities(modelName string, messages []modeld.Message, args []modeld.ChatArgument, supportsThink bool) (openAIChatRequest, map[string]string) {
