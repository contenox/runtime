...
func decodeOpenVINOParsedToolCall(raw json.RawMessage, seq int) (modeld.ToolCall, error) {
	var direct struct {
	...
	return modeld.ToolCall{}, errors.New("openvino: parser returned unsupported tool_call shape")
}

func newOpenVINOToolCall(seq int, name string, args json.RawMessage) modeld.ToolCall {
