...
func buildVertexRequest(modelName string, messages []modeld.Message, args []modeld.ChatArgument, canThink ...bool) (vertexRequest, error) {
...
func convertToVertexContents(messages []modeld.Message) []vertexContent {
