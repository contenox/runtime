import { Button, Form, FormField, Input, P, Panel, Select, Textarea } from '@contenox/ui';
    ...
    <Form
      ...
      <FormField label={t('mcp_servers.transport')} required>
        <Select
          ...
          disabled={isPending}
          options={[
            { value: 'http', label: t('mcp_servers.transport_http') },
            { value: 'sse', label: t('mcp_servers.transport_sse') },
            { value: 'stdio', label: t('mcp_servers.transport_stdio') },
          ]}
        />
      </FormField>
      ...
      <FormField label={t('mcp_servers.auth')}>
        <Select
          ...
          options={[
            { value: '', label: t('mcp_servers.auth_none') },
            { value: 'bearer', label: t('mcp_servers.auth_bearer') },
            { value: 'oauth', label: t('mcp_servers.auth_oauth') },
          ]}
        />
      </FormField>
        ...
        <>
          ...
          <FormField label={t('mcp_servers.auth_token')}>
            <Input
              ...
              disabled={isPending}
            />
            <Panel variant="flat" className="text-xs">
