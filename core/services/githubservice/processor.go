...
func (p *GitHubCommentProcessor) ProcessJob(ctx context.Context, job *store.Job) (err error) {
	...
	// There is not way in persisting the additions without duplicating them the next sync.
	// This is why this code is commented out.
	// Reason: local-time is not equal the github-api-time and the comment-id is generated by the github-api.
	// So there is no way to compute a diff of chat histories.
	//
