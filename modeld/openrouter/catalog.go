...
func init() {
	modeld.RegisterCatalogProvider("openrouter", func(spec modeld.BackendSpec, opts modeld.CatalogOptions) (modeld.CatalogProvider, error) {
...
func toObservedModel(m orModel) (modeld.ObservedModel, bool) {
	...
	default:
		...
		return modeld.ObservedModel{}, false
	}
	return om, true
}
