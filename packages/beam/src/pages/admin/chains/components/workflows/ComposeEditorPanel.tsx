...
export const ComposeEditorPanel: React.FC<ComposeEditorPanelProps> = ({
  ...
  return (
    <Panel className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-6 overflow-y-auto p-6">
          ...
          label={
            <div className="flex items-center gap-2">
              ...
              <Tooltip content={t('chains.compose_with_variable_help')}>
                <HelpCircle className="text-text-muted h-4 w-4 cursor-help" />
              </Tooltip>
            </div>
          }
          required>
        ...
        {getCurrentStrategy() && (
          <Panel variant="info">
            ...
            <Panel variant="surface" className="p-3">
      ...
      <div className="bg-surface-50/50 dark:bg-dark-surface-50/50 border-t border-surface-300 dark:border-dark-surface-400 p-6">
