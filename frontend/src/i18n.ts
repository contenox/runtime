  ...
  en: {
    translation: {
      ...
      chains: {
        ...
        list_empty_message: 'Create your first chain to get started',
        ...
        preview_hint: 'This is a visual representation of your chain workflow',
      ...
      backends: {
        ...
        pool_removed_success: 'Backend was removed from pool',
        pool_remove_error: 'Failed to remove backend from pool',
        pool_assigned_success: 'Backend was assigned to pool',
      ...
      model: {
        ...
        pool_removed_success: 'model was removed from the Pool',
        pool_remove_error: 'Error removing model from pool',
        pool_remove_success: 'model was removed from the Pool',
        pool_assign_error: 'Error assigning model to pool',
        pool_assigned_success: 'model was assigned to the Pool',
      },
      chat: {
        ...
        system_input_placeholder: 'Type your system prompt...',
      ...
      serverJobs: {
        ...
        noPendingJobsDescription: 'There are currently no jobs waiting in the queue',
        noInProgressJobs: 'No active jobs',
        noInProgressJobsDescription: 'There are currently no jobs being processed',
      },
      search: {
        title: 'Search',
        placeholder: 'Search...',
  ...
  de: {
    translation: {
      ...
      backends: {
        ...
        pool_removed_success: 'Pool erfolgreich entfernt',
