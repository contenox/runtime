...
func (p modelProfile) capabilityConfig() modeld.CapabilityConfig {
	return modeld.CapabilityConfig{
...
func mergeCapabilities(base, profile modeld.CapabilityConfig) modeld.CapabilityConfig {
