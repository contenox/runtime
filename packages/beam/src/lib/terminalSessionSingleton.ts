 ...
 *
 * sessionStorage persists the id per browser tab across reloads; this layer
 * dedupes within the SPA session. Cleared when the user closes the terminal
 * or we explicitly drop the session.
 */
