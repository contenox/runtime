...
func buildGeminiRequest(modelName string, messages []modeld.Message, systemInstruction *geminiSystemInstruction, args []modeld.ChatArgument, canThink ...bool) (geminiGenerateContentRequest, error) {
	// Collect chat args
...
func convertToGeminiMessages(messages []modeld.Message) []geminiContent {
