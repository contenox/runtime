...
export default function LLMConfigFields({
  ...
  const selectedTools = config.tools ?? config.hooks ?? [];
    ...
    <Collapsible
      ...
      <div className="space-y-4 pt-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label className="block text-sm font-medium">
              {t('chains.task_form.tools', 'Tools')}
            </Label>
            <Input
              ...
              placeholder="*, !local_shell, local_fs"
            />
            <P className="text-text-muted mt-1 text-xs">
              {t('chains.task_form.tools_help', 'Registry tools providers exposed to this model task.')}
            </P>
          </div>
