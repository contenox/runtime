...
> [modeld setup artifact detection](modeld-setup-artifact-detection.md) — specifically
...
> [modeld release artifacts](modeld-release-artifacts.md) still apply; only the
...
- No change to how dependency bundles / final packages are produced
  ([modeld release artifacts](modeld-release-artifacts.md)); only versioning, keying,
